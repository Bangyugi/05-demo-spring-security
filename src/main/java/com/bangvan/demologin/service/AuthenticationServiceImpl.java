...
public class AuthenticationServiceImpl implements AuthenticationService {
    ...
    public AuthenticationResponse authenticate(AuthenticationRequest authenticationRequest) {
        ...
        var token = generateToken(authenticationRequest.getUsername()); // Kiểu dữ liệu var giống với auto bên c++
    ...
    private String generateToken(String username) {
        ...
        JWTClaimsSet jwtClaimsSet = new JWTClaimsSet.Builder() // JWTClaimsSet được sử dụng để xây dựng các claims (dữ liệu) của token
                .subject(username) // subject: Tên đăng nhập.
                ...
                .claim("customClaim", "Custom") //claim: Thêm một claim tùy chỉnh.
                .build();
